# Installation — repo-to-roadmap v1.0.0

Distributable unit: the whole `repo-to-roadmap/` directory (keep `SKILL.md`, `references/`, `scripts/`, `agents/` paths intact).
...
```bash
ln -s "$(pwd)/skills/repo-to-roadmap" ~/.cursor/skills/repo-to-roadmap
```
...
```text
@repo-to-roadmap — <your task in plain language>
```
